...
//! use std::path::Path;
//!
//! use zotero_mcp_rs::semantic_search::{
    ...
    Send + Sync + std::fmt::Debug
{
    ...
    /// # Errors
    ///
    /// Returns [`ZoteroMcpError::Embedding`] if model inference fails.
...
/// # Errors
///
/// Returns [`ZoteroMcpError::LocalDb`] if `override_path` is [`None`] and no
