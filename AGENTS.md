...
This project is indexed by GitNexus as **zotero-mcp-rs** (2272 symbols, 4960 relationships, 195 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/zotero-mcp-rs/context` | Codebase overview, check index freshness |
| `gitnexus://repo/zotero-mcp-rs/clusters` | All functional areas |
| `gitnexus://repo/zotero-mcp-rs/processes` | All execution flows |
| `gitnexus://repo/zotero-mcp-rs/process/{name}` | Step-by-step execution trace |
